...
type RegisterDataNodeReq struct {
	...
	DiskUsage int32 `protobuf:"varint,2,opt,name=DiskUsage,proto3" json:"DiskUsage,omitempty"`
}
...
func (x *RegisterDataNodeReq) GetDiskUsage() int32 {
	if x != nil {
		return x.DiskUsage
	}
	return 0
...
var file_proto_dfs_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x44, 0x69, 0x73, 0x6b, 0x55, 0x73, 0x61, 0x67, 0x65, 0x22,
	...
	0x63, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x62, 0x6c,
